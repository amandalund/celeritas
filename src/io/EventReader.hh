 ...
 * events and their associated primary particles. Supported forrmats are
 * Asciiv3, IO_GenEvent, HEPEVT, and LHEF.
 */
class EventReader
{
  public:
  ...
  public:
    ...
    // Generate events and associated primary particles from the event record
